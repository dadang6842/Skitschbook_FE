  ...
  return (
    <div className="width-wrapper">
      <div className="container">
        ...
        <GreyBox>프로필</GreyBox>
        <PinkButton onClick={() => navigate("/changeName")}>
          이름 변경
        </PinkButton>
        <GreyBox>정보</GreyBox>
        <GreyBox>버전</GreyBox>
        <PinkButton onClick={() => navigate("/inquiry")}>문의하기</PinkButton>
        <SmallPinkButton onClick={handleLogout}>로그아웃</SmallPinkButton>
        <SmallPinkButton onClick={handleWithdraw}>회원탈퇴</SmallPinkButton>
        <SNSButton />
      </div>
    </div>
  );
